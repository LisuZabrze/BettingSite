...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference("Bet.count") do
      post bets_url, params: { bet: { game_id: @bet.game_id, score_difference: @bet.score_difference, team: @bet.team, user_id: @bet.user_id } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { game_id: @bet.game_id, score_difference: @bet.score_difference, team: @bet.team, user_id: @bet.user_id } }
